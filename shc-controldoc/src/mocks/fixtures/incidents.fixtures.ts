...
export const incidentFixtures: Incidente[] = [
  ...
  {
    id: 'inc-e2-001',
    numero: 'INC-2026-E2-001',
    tipo: 'CUASI_ACCIDENTE',
    estado: 'ABIERTO',
    severidad: 'MEDIA',
    descripcion: 'Casi-accidente por caída de contenedor mal asegurado durante maniobra de grúa portuaria en muelle.',
    areaId: 'area-001',
    empresaId: 'empresa-002',
    turno: 'DIA',
    fechaEvento: '2026-06-01T09:00:00Z',
    fechaReporte: '2026-06-01T09:20:00Z',
    ...
    accionesCorrectivas: [],
    creadoEn: '2026-06-01T09:20:00Z',
    actualizadoEn: '2026-06-01T09:20:00Z',
  },
  {
    id: 'inc-e2-002',
    numero: 'INC-2026-E2-002',
    tipo: 'CONDICION_INSEGURA',
    estado: 'EN_INVESTIGACION',
    severidad: 'BAJA',
    descripcion: 'Señalización de zona de tránsito peatonal deteriorada en el patio de contenedores del terminal.',
    areaId: 'area-002',
    empresaId: 'empresa-002',
    turno: 'TARDE',
    fechaEvento: '2026-06-05T14:00:00Z',
    fechaReporte: '2026-06-05T14:15:00Z',
    ...
    accionesCorrectivas: [],
    creadoEn: '2026-06-05T14:15:00Z',
    actualizadoEn: '2026-06-05T14:15:00Z',
  },
  {
    id: 'inc-e2-003',
    numero: 'INC-2026-E2-003',
    tipo: 'ACCIDENTE',
    estado: 'CERRADO',
    severidad: 'ALTA',
    descripcion: 'Trabajador portuario sufrió corte profundo en la mano al manipular flejes metálicos de un contenedor.',
    areaId: 'area-001',
    empresaId: 'empresa-002',
    turno: 'NOCHE',
    fechaEvento: '2026-04-10T22:00:00Z',
    fechaReporte: '2026-04-10T22:20:00Z',
    reportadoPorId: 'user-jefecalidad-101',
    huboLesionados: true,
    numPersonasAfectadas: 1,
    atencionMedicaRequerida: true,
    atencionMedicaDescripcion: 'Sutura y curación en tópico de emergencia del terminal.',
    auditTrail: [
      {
        id: 'aud-inc-e2-003-1',
        entidadTipo: 'Incidente',
        entidadId: 'inc-e2-003',
        accion: 'CREADO',
        estadoNuevo: 'ABIERTO',
        realizadoPorId: 'user-jefecalidad-101',
        realizadoPorNombre: 'Fernando Rojas',
        timestamp: '2026-04-10T22:20:00Z',
        generadoPorIA: false,
      },
      {
        id: 'aud-inc-e2-003-2',
    ...
    accionesCorrectivas: [],
    creadoEn: '2026-04-10T22:20:00Z',
    actualizadoEn: '2026-04-20T10:00:00Z',
  },
  {
    id: 'inc-e2-004',
    numero: 'INC-2026-E2-004',
    tipo: 'INCIDENTE',
    estado: 'ANALISIS_COMPLETADO',
    severidad: 'MEDIA',
    descripcion: 'Falla mecánica en grúa pórtico durante descarga de mineral, sin daños personales.',
    areaId: 'area-002',
    empresaId: 'empresa-002',
    turno: 'DIA',
    fechaEvento: '2026-06-10T08:00:00Z',
    fechaReporte: '2026-06-10T08:30:00Z',
    ...
    accionesCorrectivas: [],
    creadoEn: '2026-06-10T08:30:00Z',
    actualizadoEn: '2026-06-10T08:30:00Z',
  },
]
