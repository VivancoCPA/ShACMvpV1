...
export const documentFixtures: Documento[] = [
  ...
  {
    id: 'doc-e2-001',
    codigo: 'POL-CD-E2-001',
    titulo: 'Política de Gestión de Calidad — Terminal Portuario Ilo',
    tipo: 'POL',
    version: 'v1.0',
    estado: 'PUBLICADO',
    areaId: 'area-007',
    ...
    confidencialidad: 'PUBLICO',
    rolesAutorizados: [],
    autorId: 'user-jefedocs-101',
    revisorId: 'user-supervisor-101',
    aprobadorId: 'user-jefecalidad-101',
    archivoOriginalUrl: null,
    archivoOriginalNombre: null,
    archivoOriginalBloqueado: true,
    ...
    creadoEn: '2026-01-05T09:00:00.000Z',
    actualizadoEn: '2026-01-10T09:00:00.000Z',
  },
  {
    id: 'doc-e2-002',
    codigo: 'PRC-CD-E2-001',
    titulo: 'Procedimiento de Recepción de Mineral — Terminal Ilo',
    tipo: 'PRC',
    version: 'v1.0',
    estado: 'EN_REVISION',
    areaId: 'area-001',
    ...
    autorId: 'user-jefedocs-101',
    revisorId: 'user-supervisor-101',
    archivoOriginalUrl: '/mock/originales/doc-e2-002/PRC-CD-E2-001-v1.0.docx',
    archivoOriginalNombre: 'PRC-CD-E2-001-v1.0.docx',
    archivoOriginalBloqueado: false,
    archivoDistribucionUrl: null,
    qeVinculados: [],
    historialVersiones: [],
    ...
    creadoEn: '2026-02-01T09:00:00.000Z',
    actualizadoEn: '2026-02-03T09:00:00.000Z',
  },
  {
    id: 'doc-e2-003',
    codigo: 'INS-CD-E2-001',
    titulo: 'Instrucción de Trabajo: Carga de Mineral a Buque — Terminal Ilo',
    tipo: 'INS',
    version: 'v1.0',
    estado: 'BORRADOR',
    areaId: 'area-002',
    ...
    rolesAutorizados: [],
    autorId: 'user-jefedocs-101',
    archivoOriginalUrl: '/mock/originales/doc-e2-003/INS-CD-E2-001-v1.0.docx',
    archivoOriginalNombre: 'INS-CD-E2-001-v1.0.docx',
    archivoOriginalBloqueado: false,
    archivoDistribucionUrl: null,
    qeVinculados: [],
    historialVersiones: [],
    ...
    actualizadoEn: '2026-03-01T09:00:00.000Z',
  },
  {
    id: 'doc-e2-004',
    codigo: 'REG-CD-E2-001',
    titulo: 'Registro de Inspección de Equipos de Izaje — Terminal Ilo',
    tipo: 'REG',
    version: 'v1.0',
    estado: 'PUBLICADO',
    areaId: 'area-001',
    ...
    confidencialidad: 'INTERNO',
    rolesAutorizados: [],
    autorId: 'user-supervisor-101',
    revisorId: 'user-jefecalidad-101',
    aprobadorId: 'user-jefedocs-101',
    archivoOriginalUrl: null,
    archivoOriginalNombre: null,
    archivoOriginalBloqueado: true,
    ...
    actualizadoEn: '2026-01-20T09:00:00.000Z',
  },
]
