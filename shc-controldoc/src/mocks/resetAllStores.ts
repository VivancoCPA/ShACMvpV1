...
// locales (locales+zonas). Al agregar un store mutable nuevo en otro dominio,
// exportar su propio `resetStore()` (ver documents.handlers.ts como referencia)
// y registrarlo aquí — de lo contrario ese dominio no se reiniciará desde
// /dev/reset-mocks. No incluye `authFixtures`/usuarios (fuera de alcance,
// ver openspec/changes/reset-dev-only/design.md).
