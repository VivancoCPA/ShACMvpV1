...
interface ACsVencidasWidgetProps {
  accionesCorrectivasVencidas: AccionCorrectivaResumen[]
}

export function ACsVencidasWidget({ accionesCorrectivasVencidas }: ACsVencidasWidgetProps) {
