# Spec: dashboard-jefecontroldoc-view

## Purpose

Define the `JefeControlDocumentarioDashboard` page — the dedicated dashboard for the `JEFE_CONTROL_DOCUMENTARIO` role, whose v1 content is exclusively the `AccionesRequeridasWidget` panel — and the routing of `DashboardPage` to it.
