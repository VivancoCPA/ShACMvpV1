...
Backend .NET para la configuración, cambio y reset administrativo del PIN de firma (`ShacUser.PinHash`) usado para validar las firmas de cierre de Quality Event (ver requirement "Firma dual de cierre" en `be-quality-events-api`).
