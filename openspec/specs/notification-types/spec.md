...
TypeScript types for the notification system: the `Notificacion` interface, its `tipo`/`entidadTipo` enums, and the response DTOs used by the notifications API client and MSW handlers.
