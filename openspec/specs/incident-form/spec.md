...
React Hook Form + Zod form for creating and editing Incidentes SyST. Includes role-based access control, conditional fields, auto-calculated severity, evidence file upload zone with inline preview, and integration with MSW mock handlers.
