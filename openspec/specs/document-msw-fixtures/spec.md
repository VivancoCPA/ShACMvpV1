...
MSW fixture dataset for the M1 Document module. The `documentFixtures` array lives in `src/mocks/fixtures/documents.fixtures.ts` and serves as the authoritative in-memory data source for all document MSW handlers during development.
