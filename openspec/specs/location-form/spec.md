...
Formularios de creación/edición de Local (`LocalForm`) y Zona (`ZonaForm`) del módulo M6 — Administración de Locales y Zonas, incluyendo validación en vivo del plano PNG, preview con thumbnail real, y las reglas de negocio RN-LOC-001/RN-LOC-003/RN-ZON-001 aplicadas en la capa de formulario.
