...
Listado de administración de Áreas en `/admin/areas` (M6-S08 — Admin CRUD Áreas/Procesos): tabla plana, confirmación de desactivación con desglose de bloqueo por módulo, reactivación directa, y visibilidad condicionada por rol en Sidebar y acciones.
