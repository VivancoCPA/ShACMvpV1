...
Helpers de permisos de Área (M6-S08 — Admin CRUD Áreas/Procesos): administración restringida a `ADMINISTRADOR_SISTEMA`, consulta de catálogo abierta a todos los roles autenticados.
