...
`UserFormModal` — the single React Hook Form + Zod modal reused for both user creation and edit under M6 (`/usuarios`), including conditional `SUPERVISOR` fields, avatar upload with preview, and the post-create temporary password display.
