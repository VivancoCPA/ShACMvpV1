...
Formulario de creación/edición de Área (M6-S08 — Admin CRUD Áreas/Procesos): componente único con modo `create`/`edit`, manejo de error de nombre duplicado y guardado con confirmación.
