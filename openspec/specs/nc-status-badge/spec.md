# Spec: nc-status-badge

## Purpose

Defines the `NCStatusBadge` shared component that renders the 7-state NC lifecycle as styled pills. Covers semantic color mapping per state, dark mode variants, and TypeScript exhaustiveness guarantee on the color map.
