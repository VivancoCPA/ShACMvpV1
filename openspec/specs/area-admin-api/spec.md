...
Cliente Axios de administración de Áreas (M6-S08 — Admin CRUD Áreas/Procesos), a diferencia de Local/Zona no existe un cliente de solo lectura preexistente de Área que deba mantenerse desacoplado.
