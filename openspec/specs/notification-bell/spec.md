...
`NotificationBell` component rendered in `TopNav`: unread-count badge, dropdown listing notifications with read/unread distinction, click-to-navigate-and-mark-read behavior, and a "mark all as read" control.
