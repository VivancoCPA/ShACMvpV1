# Spec: shared-pagination

## Purpose

TBD — Shared pagination component providing sliding-window page controls with a "Mostrando X–Y de Z" summary. Used by NCList and any other paginated list in the app to provide a consistent, accessible pagination experience.
