# Spec: quality-event-hooks

## Purpose

TanStack Query v5 hooks for the Quality Event resource. Wraps the pure `quality-event-api` client with centralized query keys, list/detail queries, and create/update/status-transition mutations — including cache invalidation and Sonner toast feedback for success and business-rule (RN-QE-002, RN-QE-004) error paths.
