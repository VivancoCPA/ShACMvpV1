...
Handlers MSW y fixtures de administración de Áreas (M6-S08 — Admin CRUD Áreas/Procesos): store mutable en memoria, endpoints CRUD, validación de unicidad de nombre y desglose de bloqueo cross-dominio en desactivación.
