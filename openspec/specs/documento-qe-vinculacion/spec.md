# Spec: documento-qe-vinculacion

## Purpose

Vinculación real Documento↔QualityEvent vía tabla puente: los 4 endpoints simétricos (creación idempotente, eliminación, aislamiento cross-empresa), el resumen poblado en ambos `GET :id`, RN-DOC-005 evaluada en el punto real de obsoletización automática, el audit trail de cada vínculo, y el componente combobox compartido usado desde ambos detalles para buscar y vincular.
