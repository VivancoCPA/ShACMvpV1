...
Cliente Axios de administración de Locales y Zonas (M6 — Admin CRUD Locales/Zonas), independiente del cliente de solo lectura de M3. TBD: ampliar con detalle de manejo de errores no cubierto aún por requisitos explícitos.
