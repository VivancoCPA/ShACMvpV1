...
#### Scenario: getValidQETransitions returns EN_EJECUCION for REABIERTO
- **WHEN** a developer calls `getValidQETransitions('REABIERTO')`
- **THEN** the returned array equals `['EN_EJECUCION']`
